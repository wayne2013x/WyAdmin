    ...
    public static class BaseClass
    {
        ...
        public static string Post(string url, object parameter)
        {
            ...
            if (parameter != null)
            {
                ...
                {
                    PostVars.Add(item.Name, item.GetValue(parameter).ToString());
                }
            }
        ...
        public static string GetWeekByDate(DateTime dt)
        {
            ...
            return Day[Convert.ToInt32(dt.DayOfWeek.ToString("d"))].ToString();
        }
        ...
        /// 获取文件Content-Type
        /// </summary>
        public static IDictionary<string, string> GetFileContentType = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
        {
